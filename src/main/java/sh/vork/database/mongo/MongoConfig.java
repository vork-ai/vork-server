 ...
 * are used, targeting a local unauthenticated MongoDB on the default port.
 */
@Configuration
@PropertySource(value = "file:conf.d/database.properties", ignoreResourceNotFound = true)
